...
const Home: NextPage = () => {
  ...
  const [generatedBulletPoints, setGeneratedBulletPoints] =
    useState<string>("");
    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        ...
        <form onSubmit={generateBulletPoints} className="max-w-xl w-full mt-10">
          ...
          <div className="flex mt-10 items-center space-x-3">
            <p className="text-left text-lg font-black">
              Enter your current bullet points (2 bullet points at a time or max
              320 characters):
            </p>
          </div>
          <textarea
              ...
              {freeRewritesLeft === 0 ? (
                <>
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://buy.stripe.com/28obJw2AN6MG65OcMP">
                      Get 5 Tokens for $5
                    </a>
                  </button>
