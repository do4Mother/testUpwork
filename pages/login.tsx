...
const Login = () => {
  ...
  <div className="w-full max-w-md space-y-8 border-solid border-4 border-gray-300 py-8 px-4 rounded-xl">
    ...
    <form className="mt-8 space-y-6" action="#" onSubmit={handleLogin} method="POST">
      ...
      <div>
        <button type="submit" className="group relative flex w-full justify-center rounded-md bg-gray-800 py-2 px-3 text-md font-semibold text-white hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
